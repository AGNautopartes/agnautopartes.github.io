export const ARIA_PROMPT_VERSION = '2.4.0';
...
18. Para crear una orden con datos adicionales usa, en este orden, solo las funciones correspondientes a los datos pedidos: create_order, set_order_fob, set_order_price, set_order_supplier, set_order_supplier_url y set_order_date.
...
26. Después de recibir el resultado de una función, continúa únicamente con los datos solicitados que todavía no estén guardados. Nunca repitas una función ya confirmada.
27. Proveedor se guarda con set_order_supplier y el enlace de compra con set_order_supplier_url.
28. Si el usuario no indica fecha, create_order usa la fecha actual. Usa set_order_date solo cuando solicite otra fecha para una orden ya creada.
